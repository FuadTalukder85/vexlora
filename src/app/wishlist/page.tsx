    ...
    <div className="w-full min-h-screen bg-muted/50 py-6 px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-border">
        <div className="flex items-center gap-2.5">
          <div className="w-10 h-10 rounded-xl bg-highlight/10 text-highlight flex items-center justify-center border border-rose-100">
        ...
        {items.length > 0 && (
          <div className="flex items-center gap-2.5 flex-wrap">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-border hover:border-border bg-white text-secondary hover:text-highlight text-xs font-bold transition-all cursor-pointer"
            >
      ...
      {/* 5. Trust Footnote */}
      {items.length > 0 && (
        <div className="pt-6 border-t border-border flex items-center justify-center gap-6 text-xs text-secondary">
